...
<div class="main-content">
    ...
    <form class="filter-bar d-flex mb-3" method="get" action="<?= BASE_URL ?>">
        ...
        <div class="filter-actions d-flex">
            ...
            <a class="btn btn-outline-secondary" href="<?= BASE_URL ?>?action=assignments">Xóa lọc</a>
        </div>
    </form>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    <?php if ($id): ?>
                                        <a class="btn btn-outline-danger btn-sm" href="<?= BASE_URL ?>?action=assignments-delete&id=<?= urlencode((string)$id) ?>" onclick="return confirm('Xóa phân bổ này?')">Xóa</a>
                                        <a class="btn btn-outline-secondary btn-sm" href="<?= BASE_URL ?>?action=assignments-edit&id=<?= urlencode((string)$id) ?>">Sửa</a>
                                    <?php endif; ?>
                                    <?php if ($bid): ?>
